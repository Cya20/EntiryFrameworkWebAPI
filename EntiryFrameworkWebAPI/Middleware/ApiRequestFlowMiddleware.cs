...
namespace EntiryFrameworkWebAPI.Middleware
{
    public class ApiRequestFlowMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            { 
                await HandleCustomExceptions(context, new CustomeException(ex.Message));
            }
        }
        ...
        private async Task HandleCustomExceptions(HttpContext context, CustomeException exception)
        {
